  ...
  (
    ...
    const startVoiceListening = useCallback(() => {
      ...
      recognition.onresult = (event: any) => {
        ...
        // Use Quill's update API to properly handle changes
        quill.updateContents([
          { retain: position },
          { insert: transcript + " " }, // Add space after voice input
        ]);

        // Update cursor position after insertion
        quill.setSelection(position + transcript.length + 1, 0, "silent");
          ...
          <div className="z-10 flex justify-between space-x-2 bg-mint-50 p-2 border-t">
            ...
            <div className="flex space-x-2">
              ...
              <Button
                ...
                disabled={isListening || isProcessingVoice || !quill}
                variant="outline"
                size="sm"
