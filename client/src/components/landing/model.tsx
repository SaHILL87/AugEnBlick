...
const ThreeJSDraggableScene: React.FC<ThreeJSDraggableSceneProps> = ({ imageUrl = '/api/placeholder/800/500' }) => {
  ...
  const [customImageUrl, setCustomImageUrl] = useState<string>("/fallback.webp");
  ...
  useEffect(() => {
    ...
    function createShape(
      ...
      const materialType = Math.floor(0.5 * 3);
  ...
  return (
    <div className='min-h-screen absolute -z-10 ' style={styles.container} ref={mountRef}>
